...
export const { useGetAllRegisterSemesterQuery,useAddRegisterSemesterMutation, useUpdateRegisterSemesterMutation, useGetAllCoursesQuery , useAddCoursesMutation, useAddFacultiesMutation} = courseManagementApi